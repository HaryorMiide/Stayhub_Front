  ...
  useEffect(() => {
    const fetchRoomDetails = async () => {
      try {
        ...
        const { roomPhotoUrl, roomType, roomPrice, roomDescription } =
          response.room;
        ...
        // If the roomType isn't in the ROOM_TYPES list, allow manual input
        const { ROOM_TYPES } = await import("../../constant/RoomType");
